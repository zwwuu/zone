...
Bookmark _bookmarkDeserialize(
  ...
  final object = Bookmark(
    ...
    id: id,
    type: _BookmarktypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
        ItemType.job,
  );
  return object;
}
...
P _bookmarkDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_BookmarktypeValueEnumMap[reader.readByteOrNull(offset)] ??
          ItemType.job) as P;
    default:
...
extension BookmarkQueryProperty
  ...
  QueryBuilder<Bookmark, ItemType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
